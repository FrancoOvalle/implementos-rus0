...
const RUSOscania = require('./models/rusoDataScania.model'); 
const RUSOFILTRO = require('./models/rusoDataFiltroV3.model'); 
...
async function CONSULTARUSAFILTROS() {
    ...
    let data = await RUSOscania.find({}).lean();
